        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="menu">
                    <ul class="navbar-nav ml-auto mr-3 pt-sm-35">
                        <li class="nav-item"><a class="nav-link" href="{{ route('about') }}" title="Acerca de indexo">About Us</a></li>
                        <li class="nav-item dropdown">
                            <a @class(['nav-link dropdown-toggle',
                                'active' => Request::url() == url('web-design-colorado') ||
                                Request::url() == url('e-commerce-colorado') ||
                                Request::url() == url('tracking-website-colorado') ||
                                Request::url() == url('web-development-colorado') ||
                                Request::url() == url('search-engine-optimization-colorado') ||
                                Request::url() == url('call-tracking-colorado') ||
                                Request::url() == url('web-consulting-colorado')
                                ])
                               href="#" role="button" data-toggle="dropdown" aria-expanded="false">
                                Services
                            </a>
                            <div class="dropdown-menu">
                                <a @class(['dropdown-item', 'active' => Request::url() == url('web-design-colorado')]) href="{{ url('web-design-colorado') }}"><i class="ti-world text-muted mr-1"></i> Web Design</a>
                                <a @class(['dropdown-item', 'active' => Request::url() == url('e-commerce-colorado')]) href="{{ url('e-commerce-colorado') }}"><i class="ti-shopping-cart text-muted mr-1"></i> E-Commerce</a>
                                <a @class(['dropdown-item', 'active' => Request::url() == url('tracking-website-colorado')]) href="{{ url('tracking-website-colorado') }}"><i class="ti-target text-muted mr-1"></i> Tracking Websites</a>
                                <a @class(['dropdown-item', 'active' => Request::url() == url('web-development-colorado')]) href="{{ url('web-development-colorado') }}"><i class="ti-desktop text-muted mr-1"></i> Web Development</a>
                                <a @class(['dropdown-item', 'active' => Request::url() == url('search-engine-optimization-colorado')]) href="{{ url('search-engine-optimization-colorado') }}"><i class="ti-stats-up text-muted mr-1"></i> Search Engine Optimization</a>
                                <a @class(['dropdown-item', 'active' => Request::url() == url('call-tracking-colorado')]) href="{{ url('call-tracking-colorado') }}"><i class="ti-mobile text-muted mr-1"></i> Call Tracking</a>
                                <a @class(['dropdown-item', 'active' => Request::url() == url('web-consulting-colorado')]) href="{{ url('web-consulting-colorado') }}"><i class="ti-headphone-alt text-muted mr-1"></i> Web Consulting</a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{ route('website-cost-calculator') }}"><i class="ti-receipt text-muted mr-1"></i> Website Cost Calculator</a>
                                <a class="dropdown-item text-muted">More coming soon...</a>
                            </div>
                        </li>
                        <!--<li class="nav-item"><a class="nav-link" href="#" title="Portafolio">Portafolio</a></li>-->
                        <li class="nav-item"><a class="nav-link" href="{{ route('blog') }}" title="Portafolio">Blog</a></li>
                        <li class="nav-item"><a class="nav-link" href="{{ route('contact') }}" title="Contacto">Contact</a></li>
                    </ul>
                    <a id="phone-menu" href="tel:+1{{ preg_replace('/[^0-9]/', '', $settings['phone']->value) }}" class="btn-common br-type radius-50 my-2 my-lg-0">
